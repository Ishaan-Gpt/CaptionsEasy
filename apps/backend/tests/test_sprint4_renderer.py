...
def test_ass_generation():
    ...
    # MarginL/MarginR are now 8% of width (86px)
    assert "Dialogue: 0,0:00:00.00,0:00:01.00,Default,,86,86,0,,{\\fad(150,150)}Hello world" in ass_content
...
def test_ass_generation_with_animations():
    ...
    ass_content = engine.generate_ass(script)
    assert "Default,Outfit Thin,60" in ass_content
    assert "Dialogue: 0,0:00:00.00,0:00:01.00,Default,,86,86,0,,{\\fscx0\\fscy0}{\\t(0,150,\\fscx100\\fscy100)}Subtitles" in ass_content
