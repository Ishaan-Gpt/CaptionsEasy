...
export const PRESETS_LIST: PresetConfig[] = [
  ...
  // The 4 presets below were missing entirely — cartoon_stack and
  // serif_pop had zero presets referencing them (unreachable in the UI),
  // and staggered_3line/glow_stack only existed disguised under
  // differently-colored presets (staggered_splash/cyber_neon), never as
  // their own signature default look. These use each template's own
  // defaultFont/defaultHighlight from TEMPLATE_STYLES above.
  {
    id: "staggered_classic",
    name: "Staggered",
    desc: "Outfit font, staggered 3-line layout with the signature mint highlight",
    caption_template: "staggered_3line",
    font: "Outfit",
    size: 50,
    weight: "700",
    color: "#FFFFFF",
    highlight_color: "#00F5C4",
    outline: 2.5,
    shadow: 2.0,
    background_style: "none",
    y_position_percent: 71.4,
    staggered_layout: "splash",
    accent_period_enabled: false,
    word_limit: 5,
    caption_spacing_ms: 50,
    word_pacing: "dynamic",
    pause_handling: "hold",
  ...
  {
    id: "glow_stack_classic",
    name: "Glow Stack",
    desc: "Rounded Baloo 2 body text with a flat deep-blue glowing hero word",
    caption_template: "glow_stack",
    font: "Baloo 2",
    size: 50,
    weight: "800",
  ...
  {
    id: "serif_pop_classic",
    name: "Serif Pop",
    desc: "Bold brush-script hero word with the signature yellow pop dot",
    ...
    word_pacing: "dynamic",
    pause_handling: "hold",
    box_top: 80, box_bottom: 120, box_left: 60, box_right: 60,
  },
  {
    id: "cartoon_stack_classic",
    name: "Cartoon Stack",
    desc: "Playful Fredoka font with a thick border and handwritten Caveat top text",
    ...
    word_pacing: "dynamic",
    pause_handling: "hold",
    box_top: 90, box_bottom: 110, box_left: 55, box_right: 55,
  },
];
